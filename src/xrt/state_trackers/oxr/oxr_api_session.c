...
oxr_xrGetBodySkeletonFB(XrBodyTrackerFB bodyTracker, XrBodySkeletonFB *skeleton)
{
	...
	if (xrt_device_get_body_skeleton(body_tracker_fb->xdev, XRT_INPUT_FB_BODY_TRACKING, &body_skeleton_result) != XRT_SUCCESS) {
                         ...
                         XrBodyJointLocationsFB *locations)
{
	...
	const struct xrt_body_joint_location_fb *src_body_joints = body_joint_set_result.body_joint_set_fb.joint_locations;

	if (xrt_device_get_body_joints(body_tracker_fb->xdev, XRT_INPUT_FB_BODY_TRACKING, at_timestamp_ns, &body_joint_set_result) !=
	    XRT_SUCCESS) {
