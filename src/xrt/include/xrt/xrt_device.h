...
xrt_device_get_body_skeleton(struct xrt_device *xdev,
                             ...
                             struct xrt_body_skeleton *out_value)
{
	if (xdev == NULL || xdev->get_body_skeleton == NULL) {
...
xrt_device_get_body_joints(struct xrt_device *xdev,
                           ...
                           struct xrt_body_joint_set *out_value)
{
	if (xdev == NULL || xdev->get_body_joints == NULL) {
		return XRT_ERROR_DEVICE_FUNCTION_NOT_IMPLEMENTED;
	}
...
{
	if (xdev == NULL || xdev->set_body_tracking_fidelity_meta == NULL) {
		return XRT_ERROR_DEVICE_FUNCTION_NOT_IMPLEMENTED;
	}
...
{
	if (xdev == NULL || xdev->reset_body_tracking_calibration_meta == NULL) {
		return XRT_ERROR_DEVICE_FUNCTION_NOT_IMPLEMENTED;
	}
...
{
	if (xdev == NULL || xdev->set_body_tracking_calibration_override_meta == NULL) {
		return XRT_ERROR_DEVICE_FUNCTION_NOT_IMPLEMENTED;
	}
